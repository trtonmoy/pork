function UCAccordionMenu(menuWrapperID) {
  ...
  function expandCurrentItemTree() {
    ...
    var objCurrentItem = g_menuWrapper.find(
      ".uc-list-menu ul .current-menu-item"
    );
  ...
  function protectForFixed() {
    ...
    objFixedParents.each(function () {
      ...
      if (transformRule == "none") return true;
      ...
      if (fillmodeRule == "none") return true;
      ...
      if (perspectiveRule == "none") return true;
      ...
      if (filterRule == "none") return true;
  ...
  this.runMenu = function () {
    ...
    if (isClickable == false) {
      ...
      g_menuWrapper
        .find("ul.uc-list-menu li .uc-menu-item-pointer")
